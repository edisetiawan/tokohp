...
elseif ($_GET[module]=='semuaproduk'){
  ...
  while($r=mysql_fetch_array($sql)){
    ...
    echo "$isi ... <a href=produk-$r[id_produk]-$r[produk_seo].html>Selengkapnya</a><br /><br />
          Rp. <b>$harga</b> (stok: $r[stok])<br /><a href=aksi.php?module=keranjang&act=tambah&id=$r[id_produk]><img src='images/beli.jpg' border=0></a><br />
          </td></tr></table><br />";
	 }
...
echo "<table cellpadding=5>
      <tr bgcolor=#D3DCE3><th>No</th><th>Nama Produk</th><th>Berat(Kg)</th><th>Jumlah</th><th>Harga</th><th>Sub Total</th></tr>";
...
$dari = "From: redaksi@bukulokomedia.com \n";
...
mail("lukman@bukulokomedia.com",$subjek,$pesan,$dari);
